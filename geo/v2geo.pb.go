...
var file_v2geo_proto_rawDesc = []byte{
	...
	0x06, 0x70, 0x72, 0x65, 0x66, 0x69, 0x78, 0x22, 0x45, 0x0a, 0x05, 0x47, 0x65, 0x6f, 0x49, 0x50,
	...
	0x6f, 0x64, 0x65, 0x12, 0x19, 0x0a, 0x04, 0x63, 0x69, 0x64, 0x72, 0x18, 0x02, 0x20, 0x03, 0x28,
	0x0b, 0x32, 0x05, 0x2e, 0x43, 0x49, 0x44, 0x52, 0x52, 0x04, 0x63, 0x69, 0x64, 0x72, 0x22, 0x29,
	0x0a, 0x09, 0x47, 0x65, 0x6f, 0x49, 0x50, 0x4c, 0x69, 0x73, 0x74, 0x12, 0x1c, 0x0a, 0x05, 0x65,
	0x6e, 0x74, 0x72, 0x79, 0x18, 0x01, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x06, 0x2e, 0x47, 0x65, 0x6f,
	0x49, 0x50, 0x52, 0x05, 0x65, 0x6e, 0x74, 0x72, 0x79, 0x22, 0x4d, 0x0a, 0x07, 0x47, 0x65, 0x6f,
	...
	0x52, 0x06, 0x64, 0x6f, 0x6d, 0x61, 0x69, 0x6e, 0x22, 0x2d, 0x0a, 0x0b, 0x47, 0x65, 0x6f, 0x53,
	0x69, 0x74, 0x65, 0x4c, 0x69, 0x73, 0x74, 0x12, 0x1e, 0x0a, 0x05, 0x65, 0x6e, 0x74, 0x72, 0x79,
	0x18, 0x01, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x08, 0x2e, 0x47, 0x65, 0x6f, 0x53, 0x69, 0x74, 0x65,
	0x52, 0x05, 0x65, 0x6e, 0x74, 0x72, 0x79, 0x42, 0x07, 0x5a, 0x05, 0x2e, 0x2f, 0x67, 0x65, 0x6f,
...
var file_v2geo_proto_goTypes = []any{
...
func file_v2geo_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_v2geo_proto_msgTypes[0].Exporter = func(v any, i int) any {
			switch v := v.(*Domain); i {
			case 0:
				return &v.state
			case 1:
		...
		file_v2geo_proto_msgTypes[1].Exporter = func(v any, i int) any {
			switch v := v.(*CIDR); i {
			case 0:
				return &v.state
			case 1:
		...
		file_v2geo_proto_msgTypes[2].Exporter = func(v any, i int) any {
			switch v := v.(*GeoIP); i {
			case 0:
				return &v.state
			case 1:
		...
		file_v2geo_proto_msgTypes[3].Exporter = func(v any, i int) any {
		...
		file_v2geo_proto_msgTypes[4].Exporter = func(v any, i int) any {
		...
		file_v2geo_proto_msgTypes[5].Exporter = func(v any, i int) any {
		...
		file_v2geo_proto_msgTypes[6].Exporter = func(v any, i int) any {
	...
	file_v2geo_proto_msgTypes[6].OneofWrappers = []any{
